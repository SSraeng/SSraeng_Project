...
import { Hover, ButtonStyle } from '../styled_components/style';
...
function UserInfoPage() {   
    ...
    const [times, setTimes] = useState(0);
        ...
        <div style={{marginLeft:"auto",textAlign:"center"}}>
            ...
            <ButtonStyle onClick={times > 0 ? () => setTimes(times - 1) : null}>-</ButtonStyle>
            ...
            <ButtonStyle onClick={() => setTimes(parseInt(times + 1))}>+</ButtonStyle>
            <p></p>
            <Hover>
